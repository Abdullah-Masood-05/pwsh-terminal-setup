import { h2, cmd, callout, shot, table, extlink } from '../../lib/components.mjs'
...
${shot({ src: 'assets/screenshots/prompt.png', alt: 'A PowerShell prompt showing the path ~/Desktop/pwsh-terminal-setup and the branch name main.', caption: 'The installed prompt: current path plus the active git branch.' })}
...
${table(
  ...
  [
    ['Telemetry opt-out', 'Sets <code>POWERSHELL_TELEMETRY_OPTOUT</code> and <code>POWERSHELL_UPDATECHECK</code> at User scope.'],
    ['Nerd Font', 'Installs LigaConsolas Nerd Font per-user (registered in HKCU) — ligatures and icons.'],
    ['Profile', 'Writes <code>$PROFILE.CurrentUserAllHosts</code>: prompt, lazy conda, and PSReadLine config.'],
    ['Windows Terminal', 'Sets the font on <code>profiles.defaults</code> and frees <code>Ctrl+←/→</code> for word jumps.'],
  ]
)}
